...
class InputRegisters:
    ...
    def create_input_registers(self):
        self.radiator_temp_label = tk.Label(self.frame, text="Radiator Temperature: N/A")
        self.radiator_temp_label.pack(anchor='w')

        self.live_frequency_motor1_label = tk.Label(self.frame, text="Live Frequency Motor 1: N/A")
        self.live_frequency_motor1_label.pack(anchor='w')

        self.live_frequency_motor2_label = tk.Label(self.frame, text="Live Frequency Motor 2: N/A")
        ...
        self.ac_voltage_motor1_label = tk.Label(self.frame, text="AC Voltage Motor 1: N/A")
        self.ac_voltage_motor1_label.pack(anchor='w')

        self.ac_voltage_motor2_label = tk.Label(self.frame, text="AC Voltage Motor 2: N/A")
        self.ac_voltage_motor2_label.pack(anchor='w')

        self.input_RMS_current_motor1_label = tk.Label(self.frame, text="AC Current Motor 1: N/A")
        self.input_RMS_current_motor1_label.pack(anchor='w')

        self.input_RMS_current_motor2_label = tk.Label(self.frame, text="AC Current Motor 2: N/A")
        ...
        self.mcu_temperature_min_label = tk.Label(self.frame, text="MCU Temperature Min (live): N/A")
        self.mcu_temperature_min_label.pack(anchor='w')

        self.mcu_temperature_max_label = tk.Label(self.frame, text="MCU Temperature Max (live): N/A")
        self.mcu_temperature_max_label.pack(anchor='w')

        self.radiator_temperature_min_label = tk.Label(self.frame, text="Radiator Temperature Min (live): N/A")
        self.radiator_temperature_min_label.pack(anchor='w')

        self.radiator_temperature_max_label = tk.Label(self.frame, text="Radiator Temperature Max (live): N/A")
        self.radiator_temperature_max_label.pack(anchor='w')

        self.motor1_position_average_label = tk.Label(self.frame, text="Motor 1 Position Average: N/A")
        self.motor1_position_average_label.pack(anchor='w')

        self.motor1_position_max_label = tk.Label(self.frame, text="Motor 1 Position Max: N/A")
        self.motor1_position_max_label.pack(anchor='w')

        self.motor1_position_min_label = tk.Label(self.frame, text="Motor 1 Position Min: N/A")
        self.motor1_position_min_label.pack(anchor='w')

        self.motor2_position_average_label = tk.Label(self.frame, text="Motor 2 Position Average: N/A")
        self.motor2_position_average_label.pack(anchor='w')

        self.motor2_position_max_label = tk.Label(self.frame, text="Motor 2 Position Max: N/A")
        self.motor2_position_max_label.pack(anchor='w')

        self.motor2_position_min_label = tk.Label(self.frame, text="Motor 2 Position Min: N/A")
        self.motor2_position_min_label.pack(anchor='w')

        self.network_frequency_label = tk.Label(self.frame, text="Network Frequency: N/A")
        ...
        self.dc_resistance_motor1_label = tk.Label(self.frame, text="DC Resistance Motor 1: N/A")
        self.dc_resistance_motor1_label.pack(anchor='w')

        self.dc_resistance_motor2_label = tk.Label(self.frame, text="DC Resistance Motor 2: N/A")
        self.dc_resistance_motor2_label.pack(anchor='w')

        self.sweep_resonance_frequency_label = tk.Label(self.frame, text="Sweep Resonance Frequency: N/A")
    ...
    def read_input_registers(self, modbus_client):
        try:
            ...
            time.sleep(time_between_frame)
            live_frequency_motor1_response = modbus_client.read_input_registers(3, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            live_frequency_motor2_response = modbus_client.read_input_registers(18, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            ac_voltage_motor1_response = modbus_client.read_input_registers(5, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            ac_voltage_motor2_response = modbus_client.read_input_registers(6, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            RMS_current_motor1_response = modbus_client.read_input_registers(7, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            RMS_current_motor2_response = modbus_client.read_input_registers(8, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            mcu_temperature_min_response = modbus_client.read_input_registers(17, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            mcu_temperature_max_response = modbus_client.read_input_registers(18, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            radiator_temperature_min_response = modbus_client.read_input_registers(19, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            radiator_temperature_max_response = modbus_client.read_input_registers(20, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            motor1_position_average_response = modbus_client.read_input_registers(11, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            motor1_position_max_response = modbus_client.read_input_registers(12, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            motor1_position_min_response = modbus_client.read_input_registers(13, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            motor2_position_average_response = modbus_client.read_input_registers(14, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            motor2_position_max_response = modbus_client.read_input_registers(15, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            motor2_position_min_response = modbus_client.read_input_registers(16, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            network_frequency_response = modbus_client.read_input_registers(20, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            dc_resistance_motor1_response = modbus_client.read_input_registers(26, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            dc_resistance_motor2_response = modbus_client.read_input_registers(27, 1, unit=1)
            ...
            time.sleep(time_between_frame)
            sweep_resonance_frequency_response = modbus_client.read_input_registers(28, 1, unit=1)
