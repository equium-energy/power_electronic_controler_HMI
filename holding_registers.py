...
class HoldingRegisters:
    ...
    def create_holding_registers(self):
        self.initial_frequency_label = tk.Label(self.frame, text="Initial Frequency (1000): N/A")
        ...
        self.max_dc_voltage_label = tk.Label(self.frame, text="Max DC Bus Voltage (1001): N/A")
        ...
        self.min_dc_voltage_label = tk.Label(self.frame, text="Min DC Bus Voltage (1002): N/A")
        ...
        self.max_ac_voltage_motor1_label = tk.Label(self.frame, text="Max AC Voltage Motor 1 (1003): N/A")
        ...
        self.max_ac_voltage_motor2_label = tk.Label(self.frame, text="Max AC Voltage Motor 2 (1004): N/A")
        ...
        self.ac_current_motor1_label = tk.Label(self.frame, text="AC Current Motor 1 (1005): N/A")
        ...
        self.ac_current_motor2_label = tk.Label(self.frame, text="AC Current Motor 2 (1006): N/A")
        ...
        self.max_mcu_temperature_label = tk.Label(self.frame, text="Max MCU Temperature (1007): N/A")
        ...
        self.max_radiator_temperature_label = tk.Label(self.frame, text="Max Radiator Temperature (1008): N/A")
        ...
        self.sweep_min_frequency_label = tk.Label(self.frame, text="Sweep Min Frequency (1009): N/A")
        ...
        self.sweep_max_frequency_label = tk.Label(self.frame, text="Sweep Max Frequency (1010): N/A")
        ...
        self.sweep_stabilization_label = tk.Label(self.frame, text="Sweep Stabilization (1011): N/A")
