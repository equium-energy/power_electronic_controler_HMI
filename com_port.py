...
class COMConnector:
    def __init__(self, frame):
        ...
        self.connect_button = tk.Button(self.frame, text="Connect", command=self.connect_to_port)
        self.connect_button.pack()

        self.status_label = tk.Label(self.frame, text="")
        self.status_label.pack()

        self.start_polling_button = tk.Button(self.frame, text="Start Polling", command=self.start_polling)
